...
export default function Home() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="/playstudy/styles.css?v=30"
        precedence="default"
      />
      <div id="app">
      ...
      <script defer src="/pwa.js?v=30" data-playstudy="pwa" />
      <script defer src="/playstudy/player-gestures.js?v=30" data-playstudy="gestures" />
      <script defer src="/playstudy/app.js?v=30" data-playstudy="app" />
    </>
  );
}
