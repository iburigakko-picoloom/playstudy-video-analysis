...
export default function Home() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="/playstudy/styles.css?v=41"
        precedence="default"
      />
      <div id="app">
      ...
      <script defer src="/pwa.js?v=41" data-playstudy="pwa" />
      <script defer src="/playstudy/player-gestures.js?v=41" data-playstudy="gestures" />
      <script defer src="/playstudy/data-store.js?v=41" data-playstudy="storage" />
      <script defer src="/playstudy/app.js?v=41" data-playstudy="app" />
    </>
  );
}
