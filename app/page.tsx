...
export default function Home() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="/playstudy/styles.css?v=37"
        precedence="default"
      />
      <div id="app">
      ...
      <script defer src="/pwa.js?v=37" data-playstudy="pwa" />
      <script defer src="/playstudy/player-gestures.js?v=37" data-playstudy="gestures" />
      <script defer src="/playstudy/data-store.js?v=37" data-playstudy="storage" />
      <script defer src="/playstudy/app.js?v=37" data-playstudy="app" />
    </>
  );
}
