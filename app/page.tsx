...
export default function Home() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="/playstudy/styles.css?v=35"
        precedence="default"
      />
      <div id="app">
      ...
      <script defer src="/pwa.js?v=35" data-playstudy="pwa" />
      <script defer src="/playstudy/player-gestures.js?v=35" data-playstudy="gestures" />
      <script defer src="/playstudy/data-store.js?v=35" data-playstudy="storage" />
      <script defer src="/playstudy/app.js?v=35" data-playstudy="app" />
    </>
  );
}
