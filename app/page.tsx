...
export default function Home() {
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="/playstudy/styles.css?v=27"
        precedence="default"
      />
      <div id="app">
      ...
      <script defer src="/pwa.js?v=27" data-playstudy="pwa" />
      <script defer src="/playstudy/player-gestures.js?v=27" data-playstudy="gestures" />
      <script defer src="/playstudy/app.js?v=27" data-playstudy="app" />
    </>
  );
}
